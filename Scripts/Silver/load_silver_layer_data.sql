...
BEGIN
	...
	BEGIN TRY
		...
		PRINT 'Total load time for silver layer ' + CAST(DATEDIFF(SECOND, @batch_start_time, @batch_end_time) AS NVARCHAR) + 'sec';
	END TRY
	BEGIN CATCH
		PRINT 'Error occured when loading silver layer...';
